                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
							...
							oleh controller tempat view ini digunakan. --->
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control-file <?php echo form_error('image') ? 'is-invalid' : '' ?>" type="file" name="image" accept="image/png, image/jpeg, image/jpg" />
